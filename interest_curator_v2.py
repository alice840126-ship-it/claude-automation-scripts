...
# 관심사 키워드
INTERESTS = {
    "부동산": ["지식산업센터 임대", "상가 임대료", "수익형 부동산", "부동산 투자", "지식센터 분양"],
    "AI/자동화": ["AI 에이전트", "자동화 툴", "LLM 활용", "오픈소스 AI", "업무 자동화"],
    "뇌과학": ["집중력 향상", "생산성 루틴", "뇌플라티지", "수면 퀄리티", "습관 형성"],
    "PKM": ["옵시디언 활용", "지식 관리 시스템", "제텔카스텐", "노트 앱", "Second Brain"],
    "투자": ["주식 분석", "ETF 투자", "배당주", "자산 배분", "투자 포트폴리오"]
}
